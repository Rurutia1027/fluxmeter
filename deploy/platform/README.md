...
| [observability/](observability/) | Grafana + scrape/alert (**P2**)                         | Grafana NodePort / port-forward                             | **No** — README only                 |
...
| Grafana    | Full ops                             | **P2** — reuse `grafana/provisioning` + Prometheus  |
...
# P2 — unified monitoring (when ready)
